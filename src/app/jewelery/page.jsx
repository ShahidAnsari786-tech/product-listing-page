  ...
  return (
    ...
    <div className="container app px-4 mx-auto py-8 scroll-smooth"style={{ backgroundImage: `url('/images/cover.jpg')`, }}>
      <button onClick={() => window.history.back()}
        className='bg-stone-700 flex w-[125px] text-gray-300 hover:bg-stone-800 drop-shadow-lg px-4 py-2 rounded-full mb-4'>
        <IoArrowBackCircle className="mr-2 animate-spin text-2xl text-lime-400" />Go Back</button>
      <h1 className="text-xl font-bold text-stone-800 mb-4">Jewelery</h1>
