...
const Footer = () => {
  return (
    <footer className="flex see mt-10 w-full bg-stone-900 py-6">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <h2 className="text-lg font-semibold text-lime-400">Product Store</h2>
            <p className="text-gray-400">Do Shopping with awesome <span className='text-red-500 '>offers</span></p>
          </div>
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <ul className="mt-2 space-y-2">
              ...
              <li>
                <Link href="/privacy-policy" className="text-gray-400 hover:text-gray-100">
                  Privacy Policy
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-6 text-center text-sm text-gray-600 text-lime-600">
